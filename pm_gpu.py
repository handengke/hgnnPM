...
def neighbor_aggregation(sg_id):
    ...
    global device, fp_task_list, na_task_list, lsf_task_list, projected_features, attn_coefs_l, attn_coefs_r, attn_coefs_exp_sum, sg_node_degrees, processed_edge_counter
...
def local_semantic_fusion(sg_id):
    ...
    global lsf_task_list, na_features, lsf_w, lsf_b, lsf_q, semantic_w, lsf_nodes_counter, sg_real_dst_num
