'''
The original(staged) programming model with no optimization
...
if __name__=="__main__":
    ...
    #--------------------------the naive programming model with no optimization at all--------------------
    print("**************************************************************")
    print('Current processing dataset: ', dataset)
    print("**************************************************************")
    
    naive_pm_start_time=time.time()
    
    #---------------------------------to perform the FP stage-----------------------------------
    Wh_list=[]
    for i,meta_path in enumerate(meta_paths):
        cur_g=semantic_graphs[meta_path]
        Wh_i=fp_weight_list[i] @ feat_copy
        Wh_list.append(Wh_i)
    #--------------------------------------------------------------------------------------------

    #---------------------------------to perform the NA stage------------------------------------
    ...
    naive_pm_end_time=time.time()
    
    print("**************************************************************")
    print(f"naive PM: The execution time of inference process is {naive_pm_end_time-naive_pm_start_time} s")
    print("**************************************************************")
    #----------------------------------------------------------------------------------------------------